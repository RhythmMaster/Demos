...
@interface TZLApliyHomeViewController ()
...
@implementation TZLApliyHomeViewController
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    NSLog(@"self.tableView.tableHeaderView.frame:%@", NSStringFromCGRect(self.tableView.tableHeaderView.frame));

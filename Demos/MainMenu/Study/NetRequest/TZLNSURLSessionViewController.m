//
//  TZLNSURLSessionViewController.m
//  Demos
//
...
@interface TZLNSURLSessionViewController ()<NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
@implementation TZLNSURLSessionViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    //http://api.androidhive.info/volley/person_object.json    这个请求由于被重定向 跟子类派生了 所以比较慢
    //http://123.56.146.142:8080/xwpx/student/app/version2_0/appTheme
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:@"http://api.androidhive.info/volley/person_object.json".tzl_URL];
    ...
    [progressView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(20);
        make.right.equalTo(-20);
        make.top.equalTo(contentLb.mas_bottom).equalTo(20);

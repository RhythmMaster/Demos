//
//  TZLUploadImageViewController.m
//  Demos
//
...
@interface TZLUploadImageViewController ()<NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
@implementation TZLUploadImageViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:@"http://www.chuantu.biz/upload.php".tzl_URL];
    NSURLSessionConfiguration *configuration = [NSURLSessionConfiguration defaultSessionConfiguration];
    NSURLSession *session = [NSURLSession sessionWithConfiguration:configuration delegate:self delegateQueue:nil];
    request.HTTPMethod = @"POST";
    NSString *path = [[NSBundle mainBundle] pathForResource:@"tu" ofType:@"gif"];
    NSURLSessionUploadTask *task = [session uploadTaskWithRequest:request fromFile:path.tzl_URL];
    self.task = task;

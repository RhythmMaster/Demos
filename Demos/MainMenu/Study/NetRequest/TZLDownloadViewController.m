...
@interface TZLDownloadViewController ()<NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
...
@implementation TZLDownloadViewController

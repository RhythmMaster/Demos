//
//  TZLEmitterFireworksViewController.m
//  Demos
//
...
@interface TZLEmitterFireworksViewController ()
@property (nonatomic, strong) CAEmitterLayer * fireworksLayer;
@end

@implementation TZLEmitterFireworksViewController
...
- (void)setupEmitter{
    ...
    sparkCell.greenSpeed = -0.2;
    sparkCell.blueSpeed = -0.15;
